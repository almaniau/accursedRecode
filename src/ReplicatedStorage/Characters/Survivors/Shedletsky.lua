...
--local function OnShedletskyHit(self: Types.Ability, _hitbox: Types.HitboxDetails, _damage: number)
--    CommonFunctions.ApplyEffect({
--        TargetHumanoid = self.OwnerProperties.Humanoid,
--        EffectSettings = {
--            Name = "Resistance",
...
local Shedletsky: Types.Survivor = Character.CreateSurvivor({
    ...
    --            Name = "Body Armor",
    --            -- Description = "Every time Shedletsky gets damaged, he receives Resistance V for 1 second, acting as invincibility frames.",
    --            Passive = true,
    --        }),
    ...
    --            -- Description = "Shedletsky picks up a flashbang grenade and throws it after 3.5 seconds, triggering it after 3.5 seconds and flashing the killer for 3.5 seconds if they're in a 6 stud radius.",
    ...
    --            SlownessLevel = 3,
    --            -- Description = "Shedletsky reloads his gun. He takes 5 seconds to do so and gets Slowness III while reloading.",
    --            Behaviour = ReloadBehaviour,
    --        }),

    --        Justice = Ability.New({
    --            Name = "Justice",
    --            Description = "Shedletsky pulls out a gun and shoots forward while in low speed. Does 50 damage to the killer and stuns them for 4.2 seconds.",
    --            UseAnimation = "",
    --            ShotSound = "",
    --            Cooldown = 45,
