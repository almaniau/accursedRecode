...
--local function OnElliotHit(self: Types.Ability, _hitbox: Types.HitboxDetails, _damage: number)
--    CommonFunctions.ApplyEffect({
--        TargetHumanoid = self.OwnerProperties.Humanoid,
--        EffectSettings = {
--            Name = "Resistance",
...
local Elliot: Types.Survivor = Character.CreateSurvivor({
    Config = {
        Name = "Elliot",
        Quote = "*i get killed in the first 20 seconds of the round*",
        Render = "rbxassetid://108440668883002",

        Origin = {
            TooltipText = "no im not original, atleast my model is good",
    ...
    --            Name = "Body Armor",
    --            -- Description = "Every time Elliot gets damaged, he receives Resistance V for 1 second, acting as invincibility frames.",
    --            Passive = true,
    --        }),
    ...
    --            -- Description = "Elliot picks up a flashbang grenade and throws it after 3.5 seconds, triggering it after 3.5 seconds and flashing the killer for 3.5 seconds if they're in a 6 stud radius.",
    ...
    --            SlownessLevel = 3,
    --            -- Description = "Elliot reloads his gun. He takes 5 seconds to do so and gets Slowness III while reloading.",
    --            Behaviour = ReloadBehaviour,
    --        }),

    --        Justice = Ability.New({
    --            Name = "Justice",
    --            Description = "Elliot pulls out a gun and shoots forward while in low speed. Does 50 damage to the killer and stuns them for 4.2 seconds.",
    --            UseAnimation = "",
    --            ShotSound = "",
    --            Cooldown = 45,
...
Elliot.Config.Description = {
    ...
    {
        Type = "Header",
        Text = Elliot.Config.Name:upper(),
    },
    {
        Type = "Quote",
        Text = "\""..Elliot.Config.Quote.."\""
    },
    {
        Type = "Text",
    ...
    --        "Difficulty: ★★★☆☆",
    --        -- "Difficulty: 6 7",
    --        "Health: "..tostring(Elliot.GameplayConfig.Health),
    --        "Base Speed: "..tostring(Elliot.GameplayConfig.BaseSpeed),
    --        "Sprint Speed: "..tostring(math.round(Elliot.GameplayConfig.BaseSpeed * Elliot.GameplayConfig.SprintSpeedMultiplier * 10) / 10),
    --        "Max Stamina: "..tostring(Elliot.GameplayConfig.StaminaProperties.MaxStamina),
    --        "Stamina Loss per second: "..tostring(Elliot.GameplayConfig.StaminaProperties.StaminaDrain),
    --        "Stamina Gain per second: "..tostring(Elliot.GameplayConfig.StaminaProperties.StaminaGain),
    --    },
    --},
    --{
    --    Type = "Separator",
    ...
    --{
    --    Type = "Header",
    --    Text = Elliot.GameplayConfig.Abilities.BodyArmor.Name:upper(),
    --},
    --{
    --    Type = "Quote",
    ...
    --{
    --    Type = "Text",
    --    Text = "Every time Elliot gets hit, he gets <b>Resistance V</b> for 1 second, acting as invincibility frames.",
    ...
    --{
    --    Type = "Header",
    --    Text = Elliot.GameplayConfig.Abilities.Blindside.Name:upper(),
    --},
    --{
    --    Type = "Text",
    --    Text = "Elliot picks up a flashbang grenade and throws it after "..tostring(Elliot.GameplayConfig.Abilities.Blindside.ThrowDelay)..
    --        " seconds, triggering it after "..tostring(Elliot.GameplayConfig.Abilities.Blindside.TriggerDelay)..
    --        " seconds and inflicting the killer <b>Blindness</b> for "..tostring(Elliot.GameplayConfig.Abilities.Blindside.FlashTime)..
    --        " seconds if they're in a "..tostring(Elliot.GameplayConfig.Abilities.Blindside.FlashRadius)..
    --        " stud radius.",
    --},
    --{
    --    Type = "Header",
    --    Text = Elliot.GameplayConfig.Abilities.Reload.Name:upper(),
    --},
    --{
    --    Type = "Text",
    --    Text = "Elliot reloads his gun, getting <b>Slowness "..Utils.Math.IntToRoman(Elliot.GameplayConfig.Abilities.Reload.SlownessLevel)..
    --        "</b> for "..tostring(Elliot.GameplayConfig.Abilities.Reload.Duration).." seconds.",
    --},
    --{
    --    Type = "Header",
    --    Text = Elliot.GameplayConfig.Abilities.Justice.Name:upper(),
    --},
    --{
    --    Type = "Text",
    --    Text = {
    --        "Elliot shoots forward "
    --        ..tostring(Elliot.GameplayConfig.Abilities.Justice.HitboxLength).." studs. If it hits the killer, they get stunned for "
    --        ..tostring(Elliot.GameplayConfig.Abilities.Justice.StunTime).." seconds and receive "
    --        ..tostring(Elliot.GameplayConfig.Abilities.Justice.Damage).." damage.",
