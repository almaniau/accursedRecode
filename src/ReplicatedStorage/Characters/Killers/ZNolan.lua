...
local ZNolan: Types.Killer = Character.CreateKiller({
    Config = {
        Name = "ZNolan",
        Quote = "ZNolan",
...
local ZNolanNameLabel = "<font color=\"rgb(180, 180, 180)\">"..ZNolan.Config.Name.."</font>"
ZNolan.Config.Description = {
    {
        Type = "Separator",
        Text = "GENERAL INFO",
    },
    {
        Type = "Header",
        Text = ZNolan.Config.Name:upper(),
    },
    {
        Type = "Quote",
        Text = "\""..ZNolan.Config.Quote.."\"",
    },
    {
        Type = "Text",
        Text = "Once a law enforcement automaton built to enforce order, now a void-born executioner of silence. "..
            ZNolanNameLabel.." hunts those who trespass forbidden truths, warping space to pursue them through shadows. "..
    ...
    },
    {
        ...
        Text = {
            "Difficulty: ★★★☆☆",
            -- "Difficulty: 6 7",
            "Health: "..tostring(ZNolan.GameplayConfig.Health),
            "Base Speed: "..tostring(ZNolan.GameplayConfig.BaseSpeed),
            "Sprint Speed: "..tostring(math.round(ZNolan.GameplayConfig.BaseSpeed * ZNolan.GameplayConfig.SprintSpeedMultiplier * 10) / 10),
            "Max Stamina: "..tostring(ZNolan.GameplayConfig.StaminaProperties.MaxStamina),
            "Stamina Loss per second: "..tostring(ZNolan.GameplayConfig.StaminaProperties.StaminaDrain),
            "Stamina Gain per second: "..tostring(ZNolan.GameplayConfig.StaminaProperties.StaminaGain),
        },
    },
    {
        Type = "Separator",
    ...
    {
        Type = "Header",
        Text = ZNolan.GameplayConfig.Abilities.Slash.Name:upper(),
    },
    {
        Type = "Text",
        Text = ZNolanNameLabel.." performs a basic slash, dealing "..tostring(ZNolan.GameplayConfig.Abilities.Slash.Damage).." damage.",
        Image = "rbxassetid://9759886280",
    },
    --{
    --    Type = "Header",
    --    Text = ZNolan.GameplayConfig.Abilities.CallbackPing.Name:upper(),
    --},
    --{
    --    Type = "Text",
    --    Text = ZNolanNameLabel.." slows down for "..tostring(ZNolan.GameplayConfig.Abilities.CallbackPing.Duration).." seconds, revealing to him the aura of every single visible & alive survivor in the match that doesn't have <b>Undetectable</b>.",
    --},
    --{
    --    Type = "Header",
    --    Text = ZNolan.GameplayConfig.Abilities.DataAnchor.Name:upper(),
    --},
    --{
    --    Type = "Text",
    --    Text = {
    --        ZNolanNameLabel.." places a device on the floor, visible to everyone clearly but undestructible.",
    --        "If this ability is used a second time, "..ZNolanNameLabel.." will be teleported to this device instantly, destroying it in the process.",
    --    },
    --},
    --{
    --    Type = "Header",
    --    Text = ZNolan.GameplayConfig.Abilities.Overcharge.Name:upper(),
    --},
    --{
    --    Type = "Text",
    --    Text = ZNolanNameLabel.." overloads his systems with electricity, giving him <b>Speed "..Utils.Math.IntToRoman(ZNolan.GameplayConfig.Abilities.Overcharge.SpeedLevel).."</b> for "..tostring(ZNolan.GameplayConfig.Abilities.Overcharge.SpeedDuration).." seconds. "..
    --    "When the effect wears off, his systems will exhaust briefly, inflicting him with <b>Slowness "..Utils.Math.IntToRoman(ZNolan.GameplayConfig.Abilities.Overcharge.SlownessLevel).."</b> for "..tostring(ZNolan.GameplayConfig.Abilities.Overcharge.SlownessDuration).." seconds.",
    --},
}
