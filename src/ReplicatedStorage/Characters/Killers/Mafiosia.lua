...
local Mafiosia: Types.Killer = Character.CreateKiller({
    Config = {
		Name = "Mafiosia",
		Quote = "Mafiosia",
		Render = "rbxassetid://111532692142634",
        Price = 1,

        Origin = {
			TooltipText = "Mafiosia",
...
Mafiosia.Config.Description = {
    ...
    },
    {
        ...
        Text = "Once a law enforcement automaton built to enforce order, now a void-born executioner of silence. "..
            MafiosiaNameLabel.." hunts those who trespass forbidden truths, warping space to pursue them through shadows. "..
